#
#  Be sure to run `pod spec lint HBoxsTools.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "HBoxsIOS" => "master@hboxs.com" }
  # Or just: s.author    = ""
  # s.authors            = { "" => "" }
  ...
  s.source       = { :git => "https://github.com/HBoxsIOS/HBoxsTools.git", :tag => "#{s.version}" }
...
#------------------分类 ---------------------------------------------------- #
    ...
    header.source_files = 'Classes/Header/**/*.{h,m}'
    # header.frameworks = "UIKit", "Foundation", "QuartzCore", "CFNetwork"
    end
    ...
    webImage.source_files = 'Classes/WebImageManager/*.{h,m}'
    webImage.frameworks =  "UIKit", "CFNetwork"
    webImage.dependency 'SDWebImage'
    end

    s.subspec 'NetWorking' do |networking|
    networking.source_files = 'Classes/NetWorking/*.{h,m}'
    networking.frameworks = "UIKit", "Foundation", "CFNetwork"
    ...
    s.subspec 'Main' do |refresh|
    refresh.source_files = 'Classes/MYRefresh/**/*.{h,m}'
